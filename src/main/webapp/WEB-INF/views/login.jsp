...
<div id="outer">  
    <div id="middle">  
        <div id="inner">  
             <div id="content">${basePath}
				<div id="top"><img src="${basePath}/images/login-logo.jpg" width="100%" height="100px"></img></div>
				<div id="bottom" align="center">
					<div id="msg"><font color="red">${message}</font></div>
					<form id=loginform method=post name=loginform action="/login/dologin">
